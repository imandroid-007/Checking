...
import com.example.realestate.OTPReceiver.OtpReceivedInterface;
import com.example.realestate.OTPReceiver.SmsBroadcastReceiver;
...
public class OTP_Activity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        OtpReceivedInterface, GoogleApiClient.OnConnectionFailedListener{

    private ImageView backImg;
    private EditText edt1Otp, edt2Otp, edt3Otp, edt4Otp;

    private static String URL_LOGIN = "http://192.168.1.109/real_estate/registration_master_otp_store.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobNoTv.setText("Please type the verification code sent to  +91" + " " + mobileStr);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(firstDigit.matches("")){
                    ...
                    new KAlertDialog(OTP_Activity.this, KAlertDialog.ERROR_TYPE)
                            .setTitleText("Error!")
                            .setContentText("Your Entered OTP is wrong!")
...
//                .build();
                    ...
                    public void onResponse(String response) {
                        ...
                        try{
                            ...
                            if(message.equals("1")){
                                ...
                                new KAlertDialog(OTP_Activity.this, KAlertDialog.SUCCESS_TYPE)
                                        .setTitleText("Success")
                                        .setContentText("Registration successful, You can now login with your account.")
                                        .setConfirmClickListener(new KAlertDialog.KAlertClickListener() {
                                            @Override
                                            public void onClick(KAlertDialog kAlertDialog) {
                                                kAlertDialog.dismiss();
                                                //onBackPressed();
                                                Intent intent = new Intent(OTP_Activity.this, LoginActivity.class);
    ...
    public void onOtpTimeout() {
        //Toast.makeText(OTP_Activity.this, "Time out, please resend", Toast.LENGTH_LONG).show();
    }
